...
window.addEventListener('scroll', function() { /*Agrega un evento de desplazamiento a la ventana. La función anónima se ejecutará al desplazarse la ventana. */
	...
	sections.forEach( function(sect) { /*Itera sobre cada sección en la colección sections.*/
		...
		} /*omprueba si la posición desplazada más 50 es mayor que la posición superior de la sección. Si es así, obtiene el ID de la sección actual y lo almacena en current.*/
	});
...
let options = { /*Crea un objeto de opción vacío. */
  strings: ['Tecnico en Informatica', 'Desarrollador Web'], /*Establece las cadenas de subtítulos. En este caso, dos opciones de carrera.*/
